...
class StrategyMds:
    ...
    async def fetch_klines(
        ...
        *,
        ...
        :class:`~mftik.protocol.MdKlinesResult` carrying this same id. That hook
        ...
        :mod:`mftik.exchange.intervals`. It is normalized here, so what the
