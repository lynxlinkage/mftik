...
class BybitPublicRest(_BybitRestTransport):
    ...
    async def fetch_ticker_row(self, product: str, symbol: str) -> BybitTicker:
        ...
        shared :class:`~mftik.exchange.models.Ticker`, which states a price.
        """
...
class BybitRest(_BybitRestTransport):
    ...
    async def fetch_position_rows(
        ...
        :class:`~mftik.exchange.oms.Position` needs the instrument's ticker, and
    ...
    async def place_order(
        ...
        **extra: Any,
        ...
        :meth:`~mftik.exchange.bybit.trade.BybitTradeSocket.place_order`,
