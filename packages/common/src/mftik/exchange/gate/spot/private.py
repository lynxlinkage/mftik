...
:mod:`mftik.exchange.base`. It resembles the other venues' connectors because
...
* **REST** — the two recon snapshots the spot WebSocket API has no channel for
  (open orders, balances). See :mod:`mftik.exchange.gate.spot.rest`.
...
from mftik.exchange.gate.spot.client import GATE_SPOT_WS_URL, GateSpotWebSocket
from mftik.exchange.gate.spot.models import GateOrderAck, to_text
from mftik.exchange.gate.spot.protocol import GateApiError
