...
(:mod:`mftik.exchange.binance.spot`, :mod:`mftik.exchange.binance.future`) states
...
that difference as :data:`mftik.exchange.venues.ED25519`.
...
def now_ms() -> int:
    ...
    :meth:`~mftik.exchange.binance.spot.client.BinanceSpotWsApi.call` and its
    futures counterpart.
    """
