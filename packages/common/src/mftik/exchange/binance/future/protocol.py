...
:mod:`mftik.exchange.binance.protocol` and is re-exported here. What is futures'
...
:func:`mftik.exchange.binance.future.streams.group_of` maps a stream name to its
class and :class:`~mftik.exchange.binance.future.feed.BinanceFutureStream` holds
...
#: the reason :mod:`mftik.exchange.binance.feed` gives: the wrapper puts the
...
#: recon needs. See :mod:`mftik.exchange.binance.future.rest`.
