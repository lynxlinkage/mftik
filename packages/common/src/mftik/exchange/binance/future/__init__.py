...
(:mod:`mftik.exchange.binance.protocol`, :mod:`mftik.exchange.binance.socket`,
:mod:`mftik.exchange.binance.feed`) and almost nothing else. Where it differs it
...
from mftik.exchange.binance.future import methods, streams
from mftik.exchange.binance.future.client import MAX_DEPTH, BinanceFutureWsApi
...
from mftik.exchange.binance.future.user import (
    KEEPALIVE_SECONDS,
