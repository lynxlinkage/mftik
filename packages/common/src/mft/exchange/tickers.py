...
(:func:`mft.exchange.symbols.canonical`, so ``BTCUSDT``, never ``BTC_USDT``).
:func:`mft.exchange.venues.check_registry` enforces the venue half of that at
...
from mft.exchange.symbols import canonical
