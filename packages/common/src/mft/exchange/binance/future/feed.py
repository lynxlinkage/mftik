...
Lazily, for the same reason :class:`~mft.exchange.bybit.public.BybitPublicClient`
...
Each socket is a :class:`~mft.exchange.binance.feed.BinanceStreamSocket`, so
...
from mft.exchange.binance.feed import Parse as StreamParse
