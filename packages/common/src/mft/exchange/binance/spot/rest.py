...
:mod:`mft.exchange.binance.spot.private`, which composes exactly one transport.
...
from mft.exchange.binance.rest import BinanceRestError, BinanceSignedRest
from mft.exchange.binance.spot.models import (
    BinanceSpotHistoricalOrder,
    BinanceSpotMyTrade,
)
from mft.exchange.binance.spot.protocol import BINANCE_SPOT_REST_URL
...
class BinanceSpotRest(BinanceSignedRest):
    ...
    :class:`~mft.exchange.binance.spot.private.BinanceSpotPrivateClient` — the
