...
:func:`~mft.exchange.bybit.protocol.public_url`). No credential appears in the
...
from mft.exchange.models import BookLevel, OrderBook
...
class BybitBookSnapshot(BaseModel):
    ...
    symbol and nothing else — an :class:`~mft.exchange.models.OrderBook` states
