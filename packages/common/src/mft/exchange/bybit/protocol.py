...
and Binance — see :mod:`mft.exchange.tickers` for why the platform names that
...
#: Our :class:`~mft.exchange.tickers.Category` → Bybit's ``category``.
#:
...
def sign_rest(
    ...
    *,
    ...
    received to verify. :meth:`~mft.exchange.bybit.rest.BybitRest._post`
