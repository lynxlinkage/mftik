...
(:func:`~mft.exchange.bybit.protocol.public_url`), which is why the public feed
...
from mft.exchange.bybit.protocol import PRODUCTS
...
def order_book(symbol: str, *, depth: int = 50) -> str:
    ...
    :class:`~mft.exchange.bybit.feed.BybitBook` does. Depth ``1`` is the
...
def tickers(symbol: str) -> str:
    ...
    :class:`~mft.exchange.bybit.models.BybitTicker`.
    """
...
#: the shared :class:`~mft.exchange.models.Fill` states.
