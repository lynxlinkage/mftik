...
History reads — `fetch_klines`, `fetch_order_book`, `fetch_best_quote` — are on Gate, both Binance planes, and Bybit. They do not require a live feed. Paper answers ticker and book only.
