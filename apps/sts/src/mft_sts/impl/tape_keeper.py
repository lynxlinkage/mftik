...
subscriber goes (``mft_md.session.manager._stop_feed_if_unused``). Recording
...
left resting (see :class:`~mft_sts.strategy.Strategy`). This one holds no
...
from mft.exchange.models import AggTrade, Trade
