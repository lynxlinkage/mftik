...
from mftik_sts.client_order_id import slot_of
from mftik_sts.ledger import StrategyLedger
from mftik_sts.mds import StrategyMds
from mftik_sts.oms import StrategyOms
from mftik_sts.symbols import StrategySymbols
from mftik_sts.tape import StrategyTape
from mftik_sts.timer import Timer
...
class Strategy:
    ...
    Event log (wired, nothing to call):
        ...
        :mod:`mftik_sts.eventlog`. Recorded at the session's dispatch points
    ...
    #: that carries the per-session slot; see :mod:`mftik_sts.client_order_id`.
    id: int = 0
